...
func initCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			fmt.Println(ui.Hint("tinker db migrate up   Run pending migrations"))
			fmt.Println(ui.Hint("tinker db seed         Seed the database"))
			fmt.Println(ui.Hint("tinker db explore      Interactive DB browser (TUI)"))
